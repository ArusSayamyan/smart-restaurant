  ...
  <base-wrapper>
    <div class="orderDetails">
      <div class="orderDetails__info">
        <div class="orderDetails__nav">nav</div>
              ...
              <AccordionTab header="Kitchen">
                <Accordion>
                  <AccordionTab header="burgers">
                    <OrderList  v-model="products" listStyle="height:auto" dataKey="id" v-model:selection="selection" @click="selected">
                      <template> List of Products </template>
                      <template #item="slotProps">
                        <div class="flex flex-wrap p-2 align-items-center gap-3">
                          <img class="w-4rem shadow-2 flex-shrink-0 border-round" :src="slotProps.item.img" :alt="slotProps.item.name" />
